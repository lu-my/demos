...
class Address(models.Model):
    ...
    a_address = models.CharField(max_length=256, null=False, blank=False)
    a_using = models.BooleanField(default=False)
...
class OrderAddress(models.Model):
    oa_order = models.ForeignKey(Order)
    oa_address = models.ForeignKey(Address)
